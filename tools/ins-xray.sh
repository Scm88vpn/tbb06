...
wget -q -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/tools/nginx.conf" 
#mkdir -p /home/vps/public_html
wget -q -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/tools/vps.conf"
