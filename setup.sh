...
# https://raw.githubusercontent.com/Scm88vpn/permission/main/ip 
...
echo -e "${tyblue} Welcome To SCM88 AutoScript......${NC} "
sleep 2
...
WA: 081324677787
IG: https://instagram.com/tubagusfirdausofficial"
...
DOMAIN=scmvip.my.id
SUB_DOMAIN=${sub}.scmvip.my.id
CF_ID=m.zhal98@gmail.com
CF_KEY=2630b62dc5015a73af63b6ebd2420c6b191fc
set -euo pipefail
...
echo -e "└─────────────────────────────────────────┘"
sleep 1 
wget -q https://raw.githubusercontent.com/Scm88vpn/tbb06/main/tools/arzsource.sh && chmod +x arzsource.sh && ./arzsource.sh
#install ssh-vpn
echo -e "┌─────────────────────────────────────────┐"
echo -e " \E[41;1;39m          >>> Install SSH / WS <<<        \E[0m$NC"
echo -e "└─────────────────────────────────────────┘"
sleep 1
wget -q https://raw.githubusercontent.com/Scm88vpn/tbb06/main/tools/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#install ins-xray
echo -e "┌─────────────────────────────────────────┐"
echo -e " \E[41;1;39m            >>> Install Xray <<<         \E[0m$NC"
echo -e "└─────────────────────────────────────────┘"
sleep 1 
wget -q https://raw.githubusercontent.com/Scm88vpn/tbb06/main/tools/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
#install ins-xray
echo -e "┌─────────────────────────────────────────┐"
echo -e " \E[41;1;39m            >>> Install BR <<<           \E[0m$NC"
echo -e "└─────────────────────────────────────────┘"
sleep 1 
wget -q https://raw.githubusercontent.com/Scm88vpn/tbb06/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
#install ins-xray
echo -e "┌─────────────────────────────────────────┐"
...
wget -q -O /usr/bin/UDP "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/tools/UDP"
...
wget -q -O /usr/bin/add-vless "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/add-vless.sh"
wget -q -O /usr/bin/add-tr "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/add-tr.sh"
wget -q -O /usr/bin/autoreboot "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/options/autoreboot.sh"
wget -q -O /usr/bin/restart "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/options/restart.sh"
wget -q -O /usr/bin/tendang "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/options/tendang.sh"
wget -q -O /usr/bin/clearlog "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/options/clearlog.sh"
wget -q -O /usr/bin/running "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/options/running.sh"
#wget -q -O /usr/bin/cek-trafik "https://raw.githubusercontent.com/arzvpn/Arzv/main/options/cek-trafik.sh"
wget -q -O /usr/bin/speedtest "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/tools/speedtest_cli.py"
wget -q -O /usr/bin/cek-bandwidth "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/options/cek-bandwidth.sh"
wget -q -O /usr/bin/limitspeed "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/options/limitspeed.sh"
wget -q -O /usr/bin/menu-vless "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/menu/menu-vless.sh"
wget -q -O /usr/bin/menu-vmess "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/menu/menu-vmess.sh"
wget -q -O /usr/bin/menu-ss "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/menu/menu-ss.sh"
wget -q -O /usr/bin/menu-trojan "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/menu/menu-trojan.sh"
wget -q -O /usr/bin/menu-ssh "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/menu/menu-ssh.sh"
wget -q -O /usr/bin/menu-backup "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/menu/menu-backup.sh"
wget -q -O /usr/bin/menu "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/menu/menu.sh"
wget -q -O /usr/bin/webmin "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/options/webmin.sh"
wget -q -O /usr/bin/xp "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/xp.sh"
wget -q -O /usr/bin/update "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/options/update.sh"
wget -q -O /usr/bin/addhost "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/menu/addhost.sh"
wget -q -O /usr/bin/certxray "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/menu/crt.sh"
wget -q -O /usr/bin/menu-set "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/menu/menu-set.sh"
wget -q -O /usr/bin/info "https://raw.githubusercontent.com/Scm88vpn/tbb06/main/options/info.sh"
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/Scm88vpn/tbb06/main/version  )
