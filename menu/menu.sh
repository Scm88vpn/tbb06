...
Exp=$(curl -sS https://raw.githubusercontent.com/Scm88vpn/permission/main/ip | grep $MYIP | awk '{print $3}')
fi
...
clear
echo -e "${PURPLE} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${PURPLE} │  ${PURPLE}  Use Core       : ${BIGreen}SCMVIP TUNNELING ${NC}" 
...
echo -e "${PURPLE} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "  ${PURPLE}  [${BIGreen}1${PURPLE}]${GREEN} SSH/UDP ${NC}" 
...
echo -e "  ${PURPLE}  [${BIGreen}12${PURPLE}]${GREEN}INSTAL BOT TELEGRAM ${NC}" 
